...
public class PacketWrapper {
            ...
            try {
                ...
                if (!PacketAccessor.isParamsVersion()) {
                    ...
                    if (PacketAccessor.VISIBILITY != null) {
                        ...
                        setEnumField(PacketAccessor.VISIBILITY, packetParams, visible ? "ALWAYS" : "NEVER");
    ...
    private void setupDefaults(String name, int param) {
        try {
            ...
            if (PacketAccessor.isParamsVersion()) {
                ...
                setEnumField(PacketAccessor.PUSH, packetParams, "NEVER");
                setEnumField(PacketAccessor.VISIBILITY, packetParams, "ALWAYS");
    ...
    @SuppressWarnings("unchecked")
    private static void setEnumField(Field field, Object instance, String constantName) throws Exception {
        Class<?> enumClass = field.getType();
        Object enumValue = Enum.valueOf((Class<Enum>) enumClass, constantName.toUpperCase());
